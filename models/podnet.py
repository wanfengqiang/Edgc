...
class PODNet(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        self.train_loader = DataLoader(
            train_dset, batch_size=self.args['batch_size'], shuffle=True, num_workers=num_workers
        )
        self.test_loader = DataLoader(
            test_dset, batch_size=self.args['batch_size'], shuffle=False, num_workers=num_workers
        )
    ...
    def _run(self, train_loader, test_loader, optimizer, scheduler, epk):
        for epoch in range(1, epk + 1):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                [lsc_loss, flat_loss, spatial_loss] = loss_list
